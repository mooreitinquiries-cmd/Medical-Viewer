...
VITE_DICOM_UPLOAD_BATCH_SIZE=${VITE_DICOM_UPLOAD_BATCH_SIZE:-50}
VITE_DICOM_UPLOAD_BATCH_MAX_MB=${VITE_DICOM_UPLOAD_BATCH_MAX_MB:-25}
...
DICOM_UPLOAD_CONCURRENCY=${DICOM_UPLOAD_CONCURRENCY:-4}
...
AUTH_SESSION_TTL_HOURS=${AUTH_SESSION_TTL_HOURS:-8760}
